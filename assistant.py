...
def main():
    ...
    while True:
        ...
        if command == "add":
            ui.display_message(add_contact(args, phone_book))
        elif command == "change":
            ui.display_message(change_contact(args, phone_book))
        elif command == "phone":
            ui.display_message(show_phone(args, phone_book))
        elif command == "search":
            ui.display_message(search_contact(args, phone_book))
        elif command == "all":
            ui.display_message(show_all_contacts(args, phone_book))
        elif command == "add-birthday":
            ui.display_message(add_birthday(args, phone_book))
        elif command == "show-birthday":
            ui.display_message(show_birthday(args, phone_book))
        elif command == "birthdays":
            ui.display_message(birthdays(args, phone_book))
        elif command == "commands":
            ui.display_message(show_commands())
        elif command == "exit" or command == "close":
            save_data(phone_book)
            ui.display_message("Goodbye!")
            break
        else:
            ui.display_message("Invalid command. Type 'commands' for a list of available commands.")
